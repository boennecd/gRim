...
uses_openblas <- function() {
    .Call('_gRim_uses_openblas', PACKAGE = 'gRim')
}

cpp_ggmfit <- function(S, n, K, nvar, glen, gg, iter, eps, details, n_threads = 1L) {
    .Call('_gRim_cpp_ggmfit', PACKAGE = 'gRim', S, n, K, nvar, glen, gg, iter, eps, details, n_threads)
}

cpp_ggmfit_wood <- function(S, n, K, nvar, glen, gg, iter, eps, details, n_threads = 1L) {
    .Call('_gRim_cpp_ggmfit_wood', PACKAGE = 'gRim', S, n, K, nvar, glen, gg, iter, eps, details, n_threads)
}
