...
cpp_ggmfit_reg <- function(S, n, K, nvar, glen, gg, iter, eps, details) {
    .Call('_gRim_cpp_ggmfit_reg', PACKAGE = 'gRim', S, n, K, nvar, glen, gg, iter, eps, details)
}

cpp_ggmfit <- function(S, n, K, nvar, glen, gg, iter, eps, details) {
